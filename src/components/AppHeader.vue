  ...
  <header class="absolute inset-x-0 top-0 z-50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between py-4">
        <a href="/">
          <img class="h-12 w-auto" src="/src/assets/havenoflow.png" alt="HavenoFlow" />
        </a>
        <a href="https://github.com/haveno-flow" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-700">
