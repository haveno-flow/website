  ...
  <div class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
      <div class="mx-auto max-w-4xl divide-y divide-gray-900/10">
        <h2 id="faq" class="text-2xl font-bold leading-10 tracking-tight text-gray-900"><span class="sm:hidden">FAQ</span><span class="hidden sm:inline">Frequently Asked Questions</span></h2>
        <div>
